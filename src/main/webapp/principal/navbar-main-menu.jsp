                          ...
                          <div class="">
                              <div class="main-menu-header">
                                  ...
                                  <div class="user-details">
                                      <span id="more-details"><%=request.getSession().getAttribute("userLogado")%><i class="fa fa-caret-down"></i></span>
                                  </div>
                              </div>
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                              ...
                              <li class="pcoded-hasmenu">
                                  ...
                                  <ul class="pcoded-submenu">
                                      <li class=" ">
                                          <a href="principal/cadastro_usuario.jsp" class="waves-effect waves-dark">
